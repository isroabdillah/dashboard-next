...
export const Widget4 = () => {
  return (
    <div className="py-[32px] px-[25px] bg-white rounded-xl lg:w-full flex items-center justify-between">
      ...
      <div className="py-[34] px-[10px] bg-[#EEF2FF] rounded-full w-[125px] items-center justify-center border-[1px] border-[#676FA3]">
        <p className="text-[#676FA3] text-center">Indonesia</p>
      </div>
      <div className="">
        <p className="text-[#9CA3AF] text-[14px] font-light">27 Year</p>
      </div>
    </div>
  );
};
