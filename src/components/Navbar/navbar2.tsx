        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden sm:flex sm:items-center">
              ...
              <a
                href="#"
                className="text-[#656565] text-sm font-medium hover:text-[#FF5959]"
              >
                Pricing
              </a>
            </div>
          ...
          <div className="block sm:hidden bg-white border-t-2 py-2">
            <div className="flex flex-col">
              <a
                href="#"
                className="text-[#656565] text-sm font-medium hover:text-[#FF5959] mb-1"
              >
                Products
              </a>
              <a
              ...
              <div className="flex justify-between items-center border-t-2 pt-2">
                ...
                <a
                  href="#"
                  className="text-[#656565] text-sm font-medium border px-4 py-1 rounded-lg hover:text-[#FF5959] hover:border-purple-600"
                >
                  Sign up
                </a>
              </div>
